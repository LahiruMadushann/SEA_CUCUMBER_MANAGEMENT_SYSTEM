        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="bg-[#fff]">
          <View className="absolute w-[218vw] h-[80vh] left-[-62vw] top-[-49vh] bg-[#0013C0]  rounded-b-full ">
            ...
            <View className="w-auto h-[48px] mt-[5.7475vw] mx-auto">
              <Text className=" font-bold text-[#FFFFFF] ml-[10vw] text-center text-[22px] px-[31px] py-[5px] ">Fisherman Registration</Text>
              <Image
          ...
          <View className="p-4 mx-auto w-[80vw] h-[auto] mb-[-28vw] mt-[60vw] rounded-[10px] bg-[#FFFFFF] shadow-lg shadow-gray-700  ">
            ...
            <View style={styles.fieldContainer}>
              <Text style={styles.requiredLabel}>*</Text>
              <Picker style={styles.picker} selectedValue={accountType} onValueChange={(itemValue) => setAccountType(itemValue)}>
                <Picker.Item style={styles.pickerItem} label="Account Type" value="" />
                <Picker.Item style={styles.pickerItem} label="Individual" value="individual" />
                <Picker.Item style={styles.pickerItem} label="Group" value="group" />
              </Picker>
            </View>
