...
import { View, Text, StyleSheet, StatusBar, TextInput, TouchableOpacity, ScrollView, SafeAreaView, Image, Button } from "react-native";
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="bg-[#fff]">
          ...
          <View className="mt-[40vh]">
            <View className="mx-[12vw]">
              <Text className="text-[14px] text-[#000000A6]">Email Verification</Text>
              <Text className="text-[24px] font-bold text-[#000000A6]">Enter OTP Code</Text>
              <Text className="text-[14px]">Enter your 4 digit code sent to you at {email}</Text>
              <Text className="text-[14px] text-[#0013C0]">Did you enter the correct Email?</Text>
              ...
              <View className="mt-[25px] mx-auto">
                {countdown > 0 ? (
                  <Text className="text-[16px] text-gray-700">
                    Resend code in <Text className="text-[#0013C0] font-medium">{countdown} Seconds</Text>
                  </Text>
                ) : (
                  <TouchableOpacity
