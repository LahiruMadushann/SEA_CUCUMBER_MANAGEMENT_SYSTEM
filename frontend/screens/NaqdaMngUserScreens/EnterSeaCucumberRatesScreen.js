...
export default function EnterSeaCucumberRatesScreen() {
  ...
  const handleSeaCucumberRates = async () => {
    if (title == "" || description == "" || speciesType == "" || rates == "" || postedTo == "") {
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="bg-[#fff]">
          <View className="absolute w-[218vw] h-[80vh] left-[-62vw] top-[-49vh] bg-[#0013C0]  rounded-b-full ">
            ...
            <View className="w-auto h-[48px] mt-[5.7475vw] mx-auto">
              <Text className=" font-bold text-[#FFFFFF] text-center text-[22px] px-[31px] py-[5px] ">Sea Cucumber Rates</Text>
            </View>
          </View>
          ...
          <View className="mt-[20vh] mb-[5vh]">
            ...
            >
              <Text className="text-[#fff] text-[18px] font-bold text-center">Post Rates</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
