...
export default function EnterFishingDetailsScreen() {
  ...
  const handleUpdate = async () => {
    if (speciesType == "" || numOfSpecies == "" || fishingArea == "" || buyer == "" || buyingPrice == "") {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        Alert.alert("Unsuccessful", "Catch details were not saved successfully");
      }
    } catch (error) {
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="bg-[#fff]">
          <View className="absolute w-[223vw] h-[80vh] left-[-62vw] top-[-49vh] bg-[#0013C0]  rounded-b-full ">
            <View className="mt-[58vh] ">
              ...
              <Text className="text-center text-[#fff] font-bold text-[22px] mt-[2vw] fixed">Enter Catch Details</Text>
            </View>
          </View>
          ...
          <View className="mt-[30vh]">
            <View className="mt-[6vh]">
              ...
              <View style={styles.fieldContainer}>
                <Picker style={styles.picker} selectedValue={buyer} onValueChange={(itemValue) => setBuyer(itemValue)}>
                  <Picker.Item style={styles.pickerItem} label="Buyer" value="" />
                  <Picker.Item style={styles.pickerItem} label="Processor" value="Processor" />
                  <Picker.Item style={styles.pickerItem} label="Farmer" value="Farmer" />
                </Picker>
              </View>
            ...
            <View className="mt-[2vh] mb-[5vh]">
              ...
              >
                <Text className="text-[#fff] text-[18px] font-bold text-center">+ New Catch</Text>
              </TouchableOpacity>
            </View>
          </View>
        </ScrollView>
