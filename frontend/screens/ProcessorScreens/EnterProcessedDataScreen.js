...
export default function EnterProcessedDataScreen() {
  ...
  const handleUpdate = async () => {
    if (speciesType == "" || collectedFrom == "" || collectedLocation == "" || weight == "" || date == "") {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        Alert.alert("Success", "Successfully entered Sea cucumber processed details");
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="bg-[#fff]">
          <View className="absolute w-[223vw] h-[80vh] left-[-62vw] top-[-49vh] bg-[#0013C0]  rounded-b-full ">
            <View className="mt-[58vh] ">
              ...
              <Text className="text-center text-[#fff] font-bold text-[22px] mt-[10vw] fixed">Processed Sea Cucumber Details</Text>
            </View>
          </View>
          ...
          <View className="mt-[30vh]">
            <View className="mt-[6vh]">
              ...
              <Picker selectedValue={collectedFrom} onValueChange={(itemValue) => setCollectedFrom(itemValue)} style={styles.picker}>
                <Picker.Item style={styles.pickerItem} label="Collected From" value="" />
                <Picker.Item style={styles.pickerItem} label="Fished" value="fished" />
                <Picker.Item style={styles.pickerItem} label="Farmed" value="farmed" />
              </Picker>
              ...
              <View style={styles.fieldContainer}>
                ...
                <TouchableOpacity onPress={showDatepicker}>
                  <Text className="text-[#007bff] text-[15px]">{date.toDateString()}</Text>
                </TouchableOpacity>
              ...
              {image.map((img, index) => (
                <Image key={index} className="mt-[3vh] mx-auto rounded-[15px]" source={{ uri: img }} style={{ width: 300, height: 200 }} />
              ))}
            </View>
            ...
            <View className="mt-[2vh] mb-[5vh]">
              ...
              >
                <Text className="text-[#fff] text-[18px] font-bold text-center">Add Stock</Text>
              </TouchableOpacity>
            </View>
          </View>
        </ScrollView>
