        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="bg-[#fff]">
          <View className="absolute w-[223vw] h-[80vh] left-[-62vw] top-[-49vh] bg-[#0013C0]  rounded-b-full ">
            <View className="mt-[58vh] ">
              ...
              <Text className="text-center text-[#fff] font-bold text-[22px] mt-[10vw] fixed">Change Password</Text>
            </View>
          </View>
            ...
            <View className="mt-[6vh]">
              <View className="form space-y-2 mx-auto flex-row items-center">
                <TextInput
                  ...
                  required
                />
                <TouchableOpacity onPress={toggleOldPasswordVisibility} className="absolute ml-[60vw]">
                  <Image
                    source={showOldPassword ? require("../../assets/login/eye.png") : require("../../assets/login/eye-crossed.png")}
              ...
              <View className="form space-y-2 mx-auto flex-row items-center">
                ...
                <TouchableOpacity onPress={toggleNewPasswordVisibility} className="absolute ml-[60vw]">
                  <Image
                    source={showNewPassword ? require("../../assets/login/eye.png") : require("../../assets/login/eye-crossed.png")}
                    className="w-[6vw] mb-[3vh] h-[3vh]"
                  />
                </TouchableOpacity>
              </View>
