...
export default function UpdateProfilePicScreen() {
  ...
  const handleProfilePicUpdate = async () => {
    ...
    try {
      ...
      Alert.alert("Update Successful", "Your profile picture has been updated successfully");
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="bg-[#fff]">
          <View className="absolute w-[223vw] h-[80vh] left-[-62vw] top-[-49vh] bg-[#0013C0]  rounded-b-full ">
            <View className="mt-[58vh] ">
              ...
              <Text className="text-center text-[#fff] font-bold text-[22px] mt-[10vw] fixed">Change Profile Picture</Text>
            </View>
          </View>
