    ...
    axios
      ...
      .then((response) => {
        if (response.data.success) {
          Alert.alert("User Details", "Your details has been updated successfully.");
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="bg-[#fff]">
          <View className="absolute w-[223vw] h-[80vh] left-[-62vw] top-[-49vh] bg-[#0013C0]  rounded-b-full ">
            <View className="mt-[58vh] ">
              ...
              <Text className="text-center text-[#fff] font-bold text-[22px] mt-[10vw] fixed">Update Details</Text>
            </View>
          </View>
