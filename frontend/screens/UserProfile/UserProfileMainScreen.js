...
export default function UserProfileMainScreen() {
  ...
  const handleDelete = async () => {
    ...
    Alert.alert("Are you sure?", "Once you delete your account, you won't be able to recover it.", [
      {
        text: "Delete Account",
        onPress: () => {
      ...
      <View style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="bg-[#fff]">
          <View className="absolute w-[218vw] h-[80vh] left-[-62vw] top-[-49vh] bg-[#0013C0]  rounded-b-full ">
            <View className="flex-row ml-[70vw]">
              ...
              <View className="flex m-[auto] absolute mt-[110vw]">
                ...
                ) : db_role === "Assistant Director" || "DirectorGeneral" || "Minister" || "Chairman" ? (
            ...
            <View className="flex-row" style={{ zIndex: -1 }}>
              <View className="mt-[6vw] ml-[80vw] ">
                <TouchableOpacity onPress={() => navigation.navigate("UpdateProfilePicScreen")}>
                  <View className="flex m-[auto]">
                    <Image source={{ uri: profilePicUrl }} className=" w-[61px] h-[61px] rounded-full bg-[#FFFFFF] shadow-lg shadow-gray-800" />
                  </View>
                </TouchableOpacity>
              </View>
              ...
              <View className="mt-[4vh] ml-[5vw]">
                <View className="flex m-[auto] ">
                  <Text className="text-[3.5vw] text-[#FFFFFF] ">User Profile ({db_role})</Text>
                  <Text className="text-[5vw] text-[#FFFFFF] font-bold">{db_username}</Text>
                  <View className="mt-[3vw]">
                    ...
                    <Text className="text-[4vw] ml-[5vw] mt-[-5vw] text-[#FFFFFF]" style={{ fontStyle: "italic" }}>
                      {db_accountStatus}
                    </Text>
                  </View>
                </View>
          ...
          <View className="flex-row mt-[66vw] ml-[18vw]">
            <View className=" ">
              <View className="flex m-[auto] ">
                <Image source={require("../../assets/user/user.png")} className=" w-[30px] h-[30px] " />
              </View>
            </View>
          ...
          <View className="flex-row mt-[3vh] ml-[18vw]">
            <View className=" ">
              <View className="flex m-[auto] ">
                <Image source={require("../../assets/user/accountType.png")} className=" w-[30px] h-[30px] " />
              </View>
            </View>
            ...
            <View className="flex ml-[6vw] mt-[-1vw] ">
              ...
              {accountType === "individual" ? (
                <Text className="text-[3.5vw] font-light">Individual Account</Text>
              ) : accountType === "group" ? (
                <Text className="text-[3.5vw] font-light">Group Account</Text>
              ) : accountType == null ? (
                <Text className="text-[3.5vw] font-light">{db_role} Account</Text>
              ) : null}
            </View>
          </View>
          ...
          <View className="flex-row mt-[3vh] ml-[18vw]">
            <View className=" ">
              <View className="flex m-[auto] ">
                <Image source={require("../../assets/user/email.png")} className=" w-[30px] h-[30px] " />
              </View>
            </View>
          ...
          <View className="flex-row mt-[3vh] ml-[18vw]">
            <View className=" ">
              <View className="flex m-[auto] ">
                <Image source={require("../../assets/user/role.png")} className=" w-[30px] h-[30px] " />
              </View>
            </View>
          ...
          <View className="flex-row mt-[3vh] ml-[18vw]">
            <View className=" ">
              <View className="flex m-[auto] ">
                <Image source={require("../../assets/user/nic.png")} className=" w-[30px] h-[30px] " />
              </View>
            </View>
          ...
          <View className="flex-row mt-[3vh] ml-[18vw]">
            <View className=" ">
              <View className="flex m-[auto] ">
                <Image source={require("../../assets/user/gender.png")} className=" w-[30px] h-[30px] " />
              </View>
            </View>
          ...
          <View className="flex-row mt-[3vh] ml-[18vw]">
            <View className=" ">
              <View className="flex m-[auto] ">
                <Image source={require("../../assets/user/birthday.png")} className=" w-[30px] h-[30px] " />
              </View>
            </View>
          ...
          <View className="flex-row mt-[3vh] ml-[18vw]">
            <View className=" ">
              <View className="flex m-[auto] ">
                <Image source={require("../../assets/user/phone.png")} className=" w-[30px] h-[30px] " />
              </View>
            </View>
          ...
          <View className="flex-row mt-[8vw] ml-[18vw]">
            <View className=" ">
              <View className="flex m-[auto] ">
                <Image source={require("../../assets/user/address.png")} className=" w-[30px] h-[30px] " />
              </View>
            </View>
          ...
          {db_role == "Fisherman" ? (
            <View className="mt-[5vh]">
              <Text className="text-[5vw] color-[#5A73F4] font-bold mx-[auto]">Fisheries Details</Text>

              <View className="flex-row mt-[3vh] ml-[15vw]">
                <View className=" ">
                  <View className="flex m-[auto] ">
                    <Image source={require("../../assets/user/bullet.png")} className=" w-[30px] h-[30px] " />
                  </View>
                </View>
              ...
              <View className="flex-row mt-[3vh] ml-[15vw]">
                ...
                <View className="flex ml-[2vw] mt-[-1vw] ">
                  <Text className="text-[4vw] font-bold  ">Diving License No</Text>
                  <Text className="text-[3.5vw] font-light">{divingLicenseNo}</Text>
                </View>
              </View>
              ...
              {fisheriesRegNo && (
                <View className="flex-row mt-[3vh] ml-[15vw]">
                  ...
                  <View className="flex ml-[2vw] mt-[-1vw] ">
                    <Text className="text-[4vw] font-bold  ">Fishing Registration No</Text>
                    <Text className="text-[3.5vw] font-light">{fisheriesRegNo}</Text>
                  </View>
                </View>
              )}
              ...
              {boatRegNo && (
                <View className="flex-row mt-[3vh] ml-[15vw]">
                  ...
                  <View className="flex ml-[2vw] mt-[-1vw] ">
                    <Text className="text-[4vw] font-bold  ">Boat Registration No</Text>
              ...
              <View className="flex-row mt-[3vh] ml-[15vw]">
                ...
                <View className="flex ml-[2vw] mt-[-1vw] ">
                  ...
                  <Text className="text-[3.5vw] font-light">{fisheriesArea}</Text>
                </View>
              </View>
            </View>
          ) : null}
          ...
          {db_role == "Processor" ? (
            <View className="mt-[5vh]">
              <Text className="text-[5vw] color-[#5A73F4] font-bold mx-[auto]">Company Details</Text>
              ...
              <View className="flex-row mt-[3vh] ml-[15vw]">
                ...
                <View className="flex ml-[2vw] mt-[-1vw] ">
                  <Text className="text-[4vw] font-bold  ">Registration No</Text>
                  <Text className="text-[3.5vw] font-light">{processorRegNo}</Text>
                </View>
              </View>
            </View>
          ) : null}
          ...
          <View className="flex ml-[6vw]  mt-[5vh] mb-[4vh]">
            ...
            >
              <Text className="text-[#fff] text-[18px] font-bold text-center">Delete Account</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
