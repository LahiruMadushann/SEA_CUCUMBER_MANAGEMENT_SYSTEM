        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="bg-[#fff]">
            ...
            <View className="mt-[58vh] ">
              <View className="flex-row ">
                <View className=" ml-[4vw]">
                  <TouchableOpacity onPress={() => navigation.navigate("EnterOptScreen")}>
          ...
          <View className="mt-[36vh]">
            ...
            <View className="mt-[6vh]">
              <View>
                <TextInput
                  ...
                  required
                />
                <TouchableOpacity onPress={toggleNewPasswordVisibility} className="absolute mb-[5vh] ml-[75vw]">
                  <Image
              ...
              <TouchableOpacity onPress={toggleConfirmPasswordVisibility} className="absolute mt-[7vh] ml-[75vw]">
                <Image
            ...
            <View className="mt-[2vh]">
              ...
              >
                <Text className="text-[#fff] text-[15px] font-bold text-center">Update New Password</Text>
              </TouchableOpacity>
            </View>
          </View>
        </ScrollView>
