            ...
            >
              <View className="flex ">
                ...
                <Text className="text-center text-[12px] mt-[4] ml-[30vw] mr-[9vw] flex-auto">
                  Foster the growth of seacucumbers through ensuring quality and sustainability.
                </Text>
              </View>
            </TouchableOpacity>
            ...
            >
              <View className="flex ">
                ...
                <Text className="text-center text-[12px] mt-1 ml-[30vw] mr-[5vw] flex-auto ">
                  Delve into the world of seacucumbers, gaining insights to enhance your understanding.
                </Text>
              </View>
            </TouchableOpacity>
          </View>
