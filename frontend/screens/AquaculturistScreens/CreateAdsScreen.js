...
export default function CreateAdsScreen() {
  ...
  const handleCreateAd = () => {
    if (type == "" || title == "" || description == "" || contactNo == "" || address == "" || email == "") {
    ...
    axios
      ...
      .then((response) => {
        if (response.data.success) {
          Alert.alert("Advertisement", "Advertisement has be created Successfully.");
      ...
      .catch((error) => {
        ...
        Alert.alert("Error", "An error occurred while creating the advertisement.");
      });
  };
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="bg-[#fff]">
          <View className="absolute w-[223vw] h-[80vh] left-[-62vw] top-[-49vh] bg-[#0013C0]  rounded-b-full ">
            <View className="mt-[58vh] ">
              ...
              <Text className="text-center text-[#fff]  text-[18px] mt-[10vw] fixed">Create Advertisement</Text>
              <Text className="text-center text-[#fff] font-bold text-[22px] mt-[2vw] fixed">Vacancies | Promotions</Text>
            </View>
          </View>

          <View className="mt-[30vh]">
            <View className="mt-[6vh]">
              <View className="text-gray-700 w-auto mx-auto" style={styles.fieldContainer}>
            ...
            <View className="mt-[2vh] mb-[5vh]">
              ...
              >
                <Text className="text-[#fff] text-[18px] font-bold text-center">Create Ad</Text>
              </TouchableOpacity>
            </View>
          </View>
        </ScrollView>
