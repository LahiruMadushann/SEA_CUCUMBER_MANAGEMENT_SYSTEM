            ...
            <View className="mt-[58vh] ">
              <View className="flex-row ">
                <View className=" ml-[4vw]">
                  <TouchableOpacity onPress={() => navigation.navigate("MainFarmScreen")}>
              ...
              <Text className="text-center text-[#fff] font-bold text-[22px] mt-[5vh] fixed">Enter Stock Details</Text>
            </View>
          </View>
          ...
          <View className="mt-[36vh]">
            <View>
              ...
              <View style={styles.fieldContainer}>
                <Text className=" text-[15px] text-gray-700">Stocking Date: </Text>
                <TouchableOpacity onPress={showDatepicker}>
                  <Text className="text-[#007bff] text-[15px]">{stockingDates.toDateString()}</Text>
                </TouchableOpacity>

                {showDatePicker && <DateTimePicker value={stockingDates} mode="date" display="default" onChange={onChange} />}
              </View>
              ...
              <View style={styles.fieldContainer}>
                <Text className=" text-[15px] text-gray-700">Harvest Date: </Text>
                <TouchableOpacity onPress={showDatepickerHD}>
                  <Text className="text-[#007bff] text-[15px]">{harvest.toDateString()}</Text>
                </TouchableOpacity>

                {showDatePickerHD && <DateTimePicker value={harvest} mode="date" display="default" onChange={onChangeHD} />}
              </View>
              ...
              <View style={styles.fieldContainer}>
                <Picker style={styles.picker} selectedValue={size} onValueChange={(itemValue) => setSize(itemValue)}>
                  <Picker.Item style={styles.pickerItem} label="Size of the species" value="" />
            ...
            <View className="mt-[2vh] mb-[2vh]">
              ...
              >
                <Text className="text-[#fff] text-[18px] font-bold text-center">Enter Farming Stock</Text>
              </TouchableOpacity>
            </View>
          </View>
        </ScrollView>
