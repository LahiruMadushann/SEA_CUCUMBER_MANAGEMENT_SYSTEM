    ...
    axios
      ...
      .then((response) => {
        if (response.data.success) {
          Alert.alert("Farm Details", "Farm details has been updated successfully.");
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="bg-[#fff]">
          <View className="absolute w-[223vw] h-[80vh] left-[-62vw] top-[-49vh] bg-[#0013C0]  rounded-b-full ">
            <View className="mt-[58vh] ">
              ...
              <Text className="text-center text-[#fff]  text-[18px] mt-[10vw] fixed">Update Details</Text>
              <Text className="text-center text-[#fff] font-bold text-[22px] mt-[2vw] fixed">Aquaculture Farm</Text>
            </View>
          </View>
          ...
          <View className="mt-[36vh]">
            <View className="mt-[6vh]">
              <TextInput
                ...
                value={farmData.name}
                onChangeText={(value) => setFarmData((prevState) => ({ ...prevState, name: value }))}
              ...
              <TextInput
                ...
                onChangeText={(value) => setFarmData((prevState) => ({ ...prevState, extend: value }))}
                placeholder="Extend"
                required
              />
              <TextInput
            ...
            <View className="mt-[2vh] mb-[5vh]">
              ...
              >
                <Text className="text-[#fff] text-[18px] font-bold text-center">Update</Text>
              </TouchableOpacity>
            </View>
          </View>
        </ScrollView>
