...
import { useGetFishermensQuery } from "state/api";
...
const Fishermens = () => {
  ...
  // console.log("Fish Data Tika",dataNew)
  ...
  return (
    <Box m="1.5rem 2.5rem">
      <Header title="Fishermens" subtitle="List of Fishermens" />
      <Box
        mt="40px"
        height="75vh"
        sx={{
